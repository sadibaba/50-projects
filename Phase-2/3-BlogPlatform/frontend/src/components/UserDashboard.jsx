...
const UserDashboard = ({
  ...
  const fetchUserComments = async () => {
    ...
    try {
      const allComments = [];
      for (const blog of blogs.slice(0, 20)) {
        // cap at 20 posts max
        try {
  ...
  const handleDeletePost = async (postId) => {
    ...
    try {
      ...
      setBlogs((prev) =>
        prev.filter((blog) => (blog.id || blog._id) !== postId),
      );
        ...
        <div className="flex items-center gap-5 bg-gray-800/40 rounded-xl p-5 mb-8 border border-gray-700/50">
          <div className="relative flex-shrink-0">
            <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-purple-600/50 bg-gray-700">
              <img
                src={(currentAvatar || defaultAvatar) + `?t=${avatarKey}`}
                alt={user?.name}
        ...
        {blogs.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {blogs.map((blog) => {
              ...
              return (
                <div
                  key={id}
                  className="bg-gray-800/50 rounded-xl overflow-hidden border border-gray-800 hover:border-purple-900/50 transition-all duration-300 flex flex-col"
                >
                  {/* Image */}
          ...
          <EmptyState
            ...
            action={
              <button
                onClick={() => navigate("/home")}
                className="px-6 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg font-medium transition-all duration-300 text-sm"
              >
        ...
        {likedLoading ? (
          ...
          <EmptyState
            ...
            action={
              <button
                onClick={() => navigate("/home")}
                className="px-5 py-2 bg-gray-800 hover:bg-gray-700 text-white rounded-lg text-sm"
              >
                Browse Posts
              </button>
            }
  ...
  if (activeTab === "comments") {
    return (
      <div>
        ...
        <p className="text-gray-400 text-sm mb-6">
          Comments left by readers on your blog posts.
        </p>
        ...
        {commentsLoading ? (
          ...
          <div className="space-y-3">
            {userComments.map((comment) => (
              <div
                ...
                className="bg-gray-800/50 rounded-xl p-5 border border-gray-800 hover:border-blue-900/50 transition-colors"
              >
          ...
          <EmptyState
            ...
            subtitle={
              blogs.length
                ? "Your posts haven't received any comments yet."
                : "Create some posts first to start getting comments."
            }
            action={
              <button
                onClick={() => navigate("/home")}
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={label}>
                    ...
                    <p className="text-white text-sm bg-gray-900/60 px-3 py-2.5 rounded-lg capitalize">
                      {value}
                    </p>
                  </div>
                ))}
            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-800">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ...
                  <div
                    key={label}
                    className="bg-gray-900/60 p-4 rounded-lg text-center"
                  >
            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-800">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <button
                    key={label}
                    className="w-full py-2 bg-gray-800 hover:bg-gray-700 text-white rounded-lg text-sm font-medium transition-colors text-left px-3"
                  >
                    {label}
                  </button>
                ))}
