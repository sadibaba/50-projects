...
const PublicProfile = ({ activeTab, blogs, loading, user }) => {
  ...
  // Public profile only shows posts tab
  if (activeTab !== 'posts') {
    return (
            ...
            <div key={blog.id} className="bg-gray-800/50 rounded-xl overflow-hidden border border-gray-800 hover:border-purple-900/50 transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <button 
                  ...
                  className="w-full py-2 bg-gray-800 hover:bg-gray-700 text-white rounded-lg text-center font-medium transition-colors"
                >
                  Read Full Post
                </button>
              </div>
