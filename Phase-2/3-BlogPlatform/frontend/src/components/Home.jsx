                ...
                <>
                  ...
                  <div className="relative group">
                    <button className="flex items-center gap-2 bg-gray-800/60 px-3 py-2 rounded-lg hover:bg-gray-800 transition-colors">
                      <div className="w-7 h-7 rounded-full overflow-hidden bg-gradient-to-r from-purple-500 to-pink-500 flex-shrink-0">
                        {user?.avatar ? (
                          <img
                            src={
                            ...
                            onError={(e) => {
                              ...
                              e.target.parentElement.innerHTML = `<span class="text-white text-xs font-bold">${user.name?.charAt(0).toUpperCase() || "U"}</span>`;
                            }}
                          />
                        ) : (
                      ...
                      <span className="text-white text-sm hidden md:inline max-w-[100px] truncate">
                        {user.name}
                      </span>
                      <svg
                    ...
                    <div className="absolute right-0 mt-2 w-48 bg-gray-800 rounded-xl shadow-xl border border-gray-700 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-200 z-50 py-1">
                      <Link
                        to="/profile"
                        className="flex items-center gap-2 px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-white text-sm"
                      >
                        <svg
                          className="w-4 h-4"
                          fill="none"
                      ...
                      <button
                        onClick={handleCreateBlog}
                        className="w-full flex items-center gap-2 px-4 py-2.5 text-gray-300 hover:bg-gray-700 hover:text-white text-sm"
                      >
                        <svg
                          className="w-4 h-4"
                          fill="none"
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-2 px-4 py-2.5 text-red-400 hover:bg-red-900/20 text-sm"
                      >
                        <svg
                          className="w-4 h-4"
                          fill="none"
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  Join our community to start writing and engaging with amazing
                  content.
                </p>
              </div>
              <div className="flex gap-3 flex-shrink-0">
                <Link
                  to="/auth"
                  className="px-5 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg text-sm font-medium"
                >
                  Login
                </Link>
                <Link
                  to="/auth"
                  className="px-5 py-2 bg-gray-800 text-gray-300 rounded-lg text-sm font-medium hover:bg-gray-700"
                >
                  Sign Up
                </Link>
              </div>
